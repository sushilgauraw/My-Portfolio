...
function AboutHero() {
  return (
    ...
    <div className='about'>
        ...
        <div className='Para1'>
            <p className='Para-text1'>I am a front-end developer with a passion of developing different complex web applications.My top three favourite for learning are FreeCodeCamp,LearnCodeOnline,and Scrimba</p>
            <NavLink to= {Resume}
